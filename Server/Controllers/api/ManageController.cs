...
using EchoIsles.Server.ViewModels.ManageViewModels;
...
namespace EchoIsles.Server.Controllers.api
{
    ...
    public class ManageController : BaseController
    {
        ...
        {
            var code = await _userManager.GenerateChangePhoneNumberTokenAsync(await this.GetCurrentUserAsync(), phoneNumber);
